...
INSERT INTO NEWS(NEWS_ID, PERSON_ID, RESEARCH_GROUP_ID, MESSAGE, TIME, TITLE)VALUES(1,1,1,'Ve st�edu 30.3.2010 prob�hne sch�zka p��tel EEG.', SYSDATE ,'EEG ve�er' );
INSERT INTO NEWS(NEWS_ID, PERSON_ID, RESEARCH_GROUP_ID, MESSAGE, TIME, TITLE)VALUES(2,2,2,'Ve st�edu 7.4.2010 neprob�hne sch�zka s EEG-t�mem. D�vod: Jsem nemocn�',SYSDATE,'Zru�en� sch�zky' );
INSERT INTO NEWS(NEWS_ID, PERSON_ID, RESEARCH_GROUP_ID, MESSAGE, TIME, TITLE)VALUES(3,2,2,'Ve p�tek 9.4.2010 prob�hne u n�s v laborato�i UU-403 �kolen� t�kaj�c� se nov� EEG metody. ��ast povinn� pro v�echny experiment�tory',SYSDATE, '�kolen�' );

INSERT INTO OPINION(OPINION_ID, PERSON_ID, RESEARCH_GROUP_ID, MESSAGE, TIME, TITLE)VALUES(1,4,2,'Omlouv�m se ve st�edu nem�u p�ij�t.', SYSDATE, 'Ne��ast na sch�zce');
INSERT INTO OPINION(OPINION_ID, PERSON_ID, RESEARCH_GROUP_ID, MESSAGE, TIME, TITLE)VALUES(2,5,2,'Nem�u p�ij�t, jedu do Prahy.', SYSDATE, 'Ne��ast na sch�zce');
INSERT INTO OPINION(OPINION_ID, PERSON_ID, RESEARCH_GROUP_ID, MESSAGE, TIME, TITLE)VALUES(3,6,2,'Jak dlouho bude �kolen� trvat?', SYSDATE, 'Info o sch�zce');

INSERT INTO HISTORY(HISTORY_ID, EXPERIMENT_ID, SCENARIO_ID, PERSON_ID, DATA_FILE_ID, TIME)VALUES(1,1,1,1,1,SYSDATE);
