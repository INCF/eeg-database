...
INSERT INTO ARTICLES(ARTICLE_ID, RESEARCH_GROUP_ID, TEXT, TIME, TITLE)VALUES(1,1,'Ve st�edu 30.3.2010 prob�hne sch�zka p��tel EEG.', SYSDATE ,'EEG ve�er' );
INSERT INTO ARTICLES(ARTICLE_ID, RESEARCH_GROUP_ID, TEXT, TIME, TITLE)VALUES(2,2,'Ve st�edu 7.4.2010 neprob�hne sch�zka s EEG-t�mem. D�vod: Jsem nemocn�',SYSDATE,'Zru�en� sch�zky' );
INSERT INTO ARTICLES(ARTICLE_ID, RESEARCH_GROUP_ID, TEXT, TIME, TITLE)VALUES(3,2,'Ve p�tek 9.4.2010 prob�hne u n�s v laborato�i UU-403 �kolen� t�kaj�c� se nov� EEG metody. ��ast povinn� pro v�echny experiment�tory',SYSDATE, '�kolen�' );
