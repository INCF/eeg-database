INSERT INTO PERSON(PERSON_ID, GIVENNAME, SURNAME, DATE_OF_BIRTH, GENDER, EMAIL, PHONE_NUMBER, USERNAME, PASSWORD, AUTHORITY,CONFIRM,DEFAULT_GROUP_ID)
VALUES(1, 'Roman', 'Mou�ek', TO_DATE('5.6.1975', 'DD.MM.RR'), 'M', 'moucek@kiv.zcu.cz', 784554201, 'moucek', 'e3d30daee4bccc80bb6f34c5fe7ac82e', 'ROLE_ADMIN',1,1);
