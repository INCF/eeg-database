...
ALTER TABLE "ARTICLES_SUBSCRIBTIONS" ADD  FOREIGN KEY ("PERSON_ID") REFERENCES "PERSON" ("PERSON_ID")
;
...
ALTER TABLE "ARTICLES_SUBSCRIBTIONS" ADD  FOREIGN KEY ("ARTICLE_ID") REFERENCES "ARTICLES" ("ARTICLE_ID")
;
