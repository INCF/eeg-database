...
/**
 * ElectrodeType generated by hbm2java
 */
@Entity
@Table(name = "ELECTRODE_TYPE")
public class ElectrodeType implements java.io.Serializable {
	...
	public ElectrodeType(String title, String description, int defaultNumber,
			Set<ElectrodeLocation> electrodeLocations,
	...
	@Column(name = "ELECTRODE_TYPE_ID", nullable = false, precision = 22, scale = 0)
	public int getElectrodeTypeId() {
		return this.electrodeTypeId;
	}
	...
	@OneToMany(fetch = FetchType.LAZY, mappedBy = "electrodeType")
	...
	@JoinTable(name = "ELECTRODE_TYPE_GROUP_REL", joinColumns = { @JoinColumn(name = "ELECTRODE_TYPE_ID", nullable = false, updatable = false) }, inverseJoinColumns = { @JoinColumn(name = "RESEARCH_GROUP_ID", nullable = false, updatable = false) })
