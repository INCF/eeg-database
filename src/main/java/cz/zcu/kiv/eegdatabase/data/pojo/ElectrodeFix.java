...
/**
 * ElectrodeFix generated by hbm2java
 */
@Entity
@Table(name = "ELECTRODE_FIX")
public class ElectrodeFix implements Serializable {
	...
	public ElectrodeFix(String title, String description, int defaultNumber,
	...
	@Column(name = "ELECTRODE_FIX_ID", nullable = false, precision = 22, scale = 0)
	public int getElectrodeFixId() {
		return this.electrodeFixId;
	}
	...
	@OneToMany(fetch = FetchType.LAZY, mappedBy = "electrodeFix")
	...
	@JoinTable(name = "ELECTRODE_FIX_GROUP_REL", joinColumns = { @JoinColumn(name = "ELECTRODE_FIX_ID", nullable = false, updatable = false) }, inverseJoinColumns = { @JoinColumn(name = "RESEARCH_GROUP_ID", nullable = false, updatable = false) })
