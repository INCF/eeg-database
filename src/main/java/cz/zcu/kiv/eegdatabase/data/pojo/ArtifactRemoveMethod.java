...
/**
 * ArtifactRemoveMethod generated by hbm2java
 */
@Entity
@Table(name = "ARTEFACT_REMOVING_METHOD")
public class ArtifactRemoveMethod implements java.io.Serializable {
	...
	public ArtifactRemoveMethod(String title, String description,
	...
	@Column(name = "ARTEFACT_REMOVING_METHOD_ID", nullable = false, precision = 22, scale = 0)
	public int getArtifactRemoveMethodId() {
		return this.artifactRemoveMethodId;
	}
	...
	@JoinTable(name = "ARTEFACT_REMOVING_METHODS_REL", joinColumns = {
		@JoinColumn(name = "ARTEFACT_REMOVING_METHOD_ID", nullable = false, updatable = false)}, inverseJoinColumns = {
	...
	@ManyToMany(fetch = FetchType.LAZY)
	@JoinTable(name = "ARTEFACT_RMVNG_MTHD_GROUP_REL", joinColumns = {
		@JoinColumn(name = "ARTEFACT_REMOVING_METHOD_ID", nullable = false, updatable = false)}, inverseJoinColumns = {
