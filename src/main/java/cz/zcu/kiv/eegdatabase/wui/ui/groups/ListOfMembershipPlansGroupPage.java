...
public class ListOfMembershipPlansGroupPage extends MenuPage {
    ...
    private void setupComponents(final int groupId) {
        ...
        BookmarkablePageLink<Void> buyPlanLink = new BookmarkablePageLink<Void>("buyMembershipPlan", BuyMembershipPlanPage.class, PageParametersUtils.getDefaultPageParameters(groupId));
