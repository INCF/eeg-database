 ...
 *  ***********************************************************************************************************************
 *  
 *   HistoryLastDownloadedDataProvider.java, 2014/05/13 00:01 Jakub Rinkes
 ******************************************************************************/
...
public class HistoryLastDownloadedDataProvider extends SortableDataProvider<History, String> {
    ...
    public HistoryLastDownloadedDataProvider(HistoryFacade facade) {
        this.facade = facade;
    }

    public void setData(ChoiceHistory history, boolean isGroupAdmin, int groupId) {

        list = facade.getLastDownloadHistory(history, isGroupAdmin, groupId);
        size = list.size();
    }
