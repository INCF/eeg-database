 ...
 *  ***********************************************************************************************************************
 *  
 *   ListFileMetadataPage.java, 2013/10/02 00:01 Jakub Rinkes
 ******************************************************************************/
...
/**
 * Page with list of file metadata parameters.
 * 
 * @author Jakub Rinkes
 *
 */
    ...
    private void setupComponents() {
        ...
        if (isAdmin) {
            ResearchGroup defaultGroup = new ResearchGroup(CoreConstants.DEFAULT_ITEM_ID,
                    EEGDataBaseSession.get().getLoggedUser(), ResourceUtils.getString("label.defaultFileMetadataParamDef"), "-");
        ...
        PropertyListView<FileMetadataParamDef> params = new PropertyListView<FileMetadataParamDef>("params", model) {
        ...
        AjaxLink<Void> link = new AjaxLink<Void>("addMetadataLink") {
            ...
            public void onClick(AjaxRequestTarget target) {
                ...
                setResponsePage(FileMetadataFormPage.class, PageParametersUtils.getPageParameters(PageParametersUtils.GROUP_PARAM, researchGroupId));
            }
        };
