 ...
 */
public class GetOntologySchema extends Page {

    private Log log = LogFactory.getLog(getClass());
    @SpringBean
    private SemanticFactory semanticFactory;

    public GetOntologySchema(final PageParameters parameters) throws Exception {

        StringValue type = parameters.get("type");
        log.debug("type: " + type);
        InputStream is = semanticFactory.getOntologySchema(type.toString());
