 ...
 */
public class GetOntology extends Page {

    private Log log = LogFactory.getLog(getClass());
    @SpringBean
    private SemanticFactory semanticFactory;

    public GetOntology(final PageParameters parameters) throws Exception {

        StringValue type = parameters.get("type");
        log.debug("type: " + type);
        InputStream is = semanticFactory.getOntology(type.toString());
