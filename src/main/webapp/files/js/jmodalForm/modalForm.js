...
$("#dialog-form-person").dialog({
        ...
        buttons: {
            "Create new person": function() {
               ...
               //bValid = bValid && checkLength(phoneNumber, "phonenumber", 0, 30);
               // bValid = bValid && checkLength(note, "note", 6, 80);

                bValid = bValid && checkRegexp(givenname, /^[a-z]+$/i, "Givenname may consist of a-z, spaces, begin with a letter.");
                bValid = bValid && checkRegexp(surname, /^[a-z]+$/i, "Surname may consist of a-z, spaces, begin with a letter.");
               ...
               // From jquery.validate.js (by joern), contributed by Scott Gonzalez: http://projects.scottsplayground.com/email_address_validation/
                ...
                //bValid = bValid && checkRegexp(phoneNumber, /^[ 0-9]+$/i, "Phone number may consist of 0-9.");
