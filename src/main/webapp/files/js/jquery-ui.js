            ...
            for (var L = this._getDefaultDate(a),I = "",D = 0; D < i[0]; D++) {
                for (var M = "",E = 0; E < i[1]; E++) {
                    ...
                    if (l) {
                        ...
                        if (i[1] > 1)switch (E) {case 0:x += " ui-datepicker-group-first";t = " ui-corner-" + (c ? "right" : "left");break;case i[1] -
