 ...
 *  ***********************************************************************************************************************
 *  
 *   ChangeRoleExperimenterToAdminTest.java, 2013/10/02 00:01 Jakub Rinkes
 ******************************************************************************/
...
public class ChangeRoleExperimenterToAdminTest {
  ...
  @Test
  public void testChangeRoleExperimenterToAdmin() throws Exception {
    ...
    // Login as user with role EXPERIMENTER and verify role
    ...
    new Select(driver.findElement(By.xpath("//select[@wicketpath='form_username']"))).selectByVisibleText("testaccountforeeg3@seznam.cz");
    ...
    driver.findElement(By.linkText("Administration")).click();
    new Select(driver.findElement(By.xpath("//select[@wicketpath='form_username']"))).selectByVisibleText("testaccountforeeg3@seznam.cz");
    new Select(driver.findElement(By.xpath("//select[@wicketpath='form_authority']"))).selectByVisibleText("Experimenter");
    driver.findElement(By.xpath("//input[@wicketpath='form_submit']")).click();
    driver.findElement(By.xpath("//a[@wicketpath='logout']")).click();
  }
