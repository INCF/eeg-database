 ...
 *  ***********************************************************************************************************************
 *  
 *   ChangeRoleReaderToAdminTest.java, 2013/10/02 00:01 Jakub Rinkes
 ******************************************************************************/
...
public class ChangeRoleReaderToAdminTest {
  ...
  @Test
  public void testChangeRoleReaderToAdmin() throws Exception {
    ...
    // Login as user with role READER and verify role
    ...
    new Select(driver.findElement(By.xpath("//select[@wicketpath='form_username']"))).selectByVisibleText("testaccountforeeg4@seznam.cz");
