...
<ui:historyTemplate pageTitle="pageTitle.weeklyDownloadHistory">
  ...
  <input type="image" src="<c:url value='/history/graph.html?graphType=WEEKLY&groupId=${defaultGroupId}'/>" name="testgraph" alt="Graph" onclick="location.href(<c:url value='/history/graph.html'/>);" />
